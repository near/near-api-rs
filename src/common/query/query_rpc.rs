...
use near_openapi_types::{
    ...
    JsonRpcResponseForRpcQueryResponseAndRpcError, RpcError, RpcQueryRequest, RpcQueryResponse,
};

use crate::{
    NetworkConfig, Reference, advanced::RpcType, common::utils::is_critical_query_error,
    config::RetryResponse, errors::SendRequestError, types::query_request::QueryRequest,
};
